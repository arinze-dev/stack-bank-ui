...
import { dashDoardThunnk,selectDashBoard} from "../../redux/auth/dashboardSlice"
import "./dashbord.css"
    ...
    <div className='dashbord'>
      <div className='side-dashbord'>
        <div className='features'>
          <button className='dashbord-btn' name='Dashbord' onClick={DisplyOption}>Dashbord </button>
          <button className='Transfer-btn' name='Transfer' onClick={DisplyOption}>Transfer</button>
          <button className='loan-btn' name='Loan' onClick={DisplyOption}>Loan</button>
          <button className='Airtime-btn' name='Airtime' onClick={DisplyOption}>Airtime</button>
        </div>
      </div>
      <div className='main-dashbord'>
            ...
            <div className='details-1'>
              <div className='detail'>
                <div className='nameSpace'>
                  {status=="fulfilled" &&
                    <>
                      <div className='nameSpace-1'> <p>Surname: </p> <p> {data.firstname}</p></div>
                    <div className='nameSpace-1'> <p>FirstName: </p> <p> {data.lastname}</p></div>
                    </>
                  }
                ...
                {status=="fulfilled" &&
                    <>
                   <div className='nameSpace-2'> <p>Phone: </p> <p> {data.phone}</p></div>
                   <div className='nameSpace-2'> <p>AccNumber: </p> <p> {data.accountnumber}</p></div>
                   </>
                  }
                </div>
              </div>
          ...
          <div className='other-element'>
            ...
            {display.Dashbord && status=="fulfilled" && userTX?.map((item,index)=>{
