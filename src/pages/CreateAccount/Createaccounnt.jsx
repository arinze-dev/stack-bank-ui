...
function Createaccounnt() {
  ...
  const onSubmit = (data) => {
    try {
      if (data.password === data.comfirmpassword) {
      ...
      } else {
        {
          data.password === data.comfirmpassword &&
            toast.error("comfirmpassword doesn't match password", {
      ...
      {
        error && data.password === data.comfirmpassword;
      }
    }
  };
  useEffect(() => {
    if (IfRegitered.status == "Fulfilled") {
      {
        IfRegitered.userRegister?.message &&
          toast.success(IfRegitered.userRegister?.message, {
    ...
    <div className="create-cont">
      <div className="main-create">
        ...
        <div className="content-create">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <input
                ...
                {...register("firstname", {
                  ...
                  minLength: { value: 2, message: "min value is 2" },
                })}
              />
              ...
              <input
                ...
                {...register("phone", {
                  ...
                  minLength: { value: 2, message: "minimum value 11" },
                  maxLength: {
                    value: 11,
                    message: " The Max phone number is 11",
                  },
                })}
              />
              ...
              <input
                ...
                {...register("password", {
                  ...
                  maxLength: {
                    value: 18,
                    message: " The Max phone number is 18",
                  },
                })}
              />
          ...
          <p>
            {" "}
            if you have account click here <Link to={"/login"}> log in </Link>
          </p>
          <hr />
        </div>
      </div>
